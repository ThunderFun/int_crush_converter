...
class TestSmoothQuantRTN:
    ...
    def test_smoothquant_rtn_int8(self, tmp_path, tmp_safetensors):
    ...
    def test_smoothquant_rtn_int4(self, tmp_path, tmp_safetensors):
    ...
    def test_smoothquant_rtn_no_calibration_weight_only(self, tmp_path, tmp_safetensors):
...
class TestSmoothQuantGPTQ:
    ...
    def test_smoothquant_gptq_with_amax(self, tmp_path, tmp_safetensors):
    ...
    def test_smoothquant_gptq_without_amax_uses_hessian(self, tmp_path, tmp_safetensors):
        ...
        _make_calibration_with_amax(
            ...
            ["layers.0.q_proj", "layers.0.k_proj"],
            [64, 64],
            include_amax_per_channel=False,
        )
    ...
    def test_smoothquant_gptq_with_rotation(self, tmp_path, tmp_safetensors):
...
class TestSmoothQuantPermuQuant:
    ...
    def test_smoothquant_with_permuquant(self, tmp_path, tmp_safetensors):
    ...
    def test_smoothquant_with_permuquant_and_rotation(self, tmp_path, tmp_safetensors):
...
class TestSmoothQuantMetadata:
    ...
    def test_smoothquant_metadata_present(self, tmp_path, tmp_safetensors):
    ...
    def test_smoothquant_in_method_string(self, tmp_path, tmp_safetensors):
    ...
    def test_smoothquant_gptq_method_string(self, tmp_path, tmp_safetensors):
    ...
    def test_smoothquant_with_permuquant_method_string(self, tmp_path, tmp_safetensors):
    ...
    def test_no_smoothquant_metadata_when_disabled(self, tmp_path, tmp_safetensors):
...
class TestSmoothQuantAlpha:
    ...
    def test_different_alpha_values(self, tmp_path, tmp_safetensors):
...
class TestSmoothQuantProgress:
    ...
    def test_smoothquant_in_progress_summary(self, tmp_path, tmp_safetensors):
        ...
        assert summaries[0].smoothquant_layers == 2

    def test_smoothquant_zero_when_disabled(self, tmp_path, tmp_safetensors):
...
class TestSmoothQuantEquivalence:
    ...
    def test_quantized_output_approximates_original(self, tmp_path, tmp_safetensors):
        ...
        state = {"layers.0.q_proj.weight": torch.randn(16, 64, dtype=torch.float32) * 0.1}
