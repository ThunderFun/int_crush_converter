...
from converter.piso import (
    _compute_piso_scales_int8_pytorch,
    _compute_piso_scales_int8_asymmetric_pytorch,
)
...
class TestPisoSymmetric:
    ...
    def test_matches_pytorch_small(self):
        ...
        pytorch_result = _compute_piso_scales_int8_pytorch(
...
class TestPisoAsymmetric:
    ...
    def test_matches_pytorch_small(self):
        ...
        pytorch_result = _compute_piso_scales_int8_asymmetric_pytorch(
            W.cpu(), h_diag.cpu(), num_coarse=32, num_fine=8
        )
